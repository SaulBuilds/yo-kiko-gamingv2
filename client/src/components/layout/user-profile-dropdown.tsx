    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-72">
        ...
        {address && (
          <DropdownMenuItem className="flex items-center p-3" onSelect={(e) => e.preventDefault()}>
            <div className="flex items-center gap-3 w-full">
              <Image src="/public/assets/logos/abstract.svg" alt="Abstract" className="h-6 w-auto" />
        ...
        {principal && (
          <DropdownMenuItem className="flex items-center p-3" onSelect={(e) => e.preventDefault()}>
            <div className="flex items-center gap-3 w-full">
              <Image src="/public/assets/logos/IC_logo_horizontal_white.svg" alt="Internet Computer" className="h-6 w-auto" />
              <div className="flex-1">
